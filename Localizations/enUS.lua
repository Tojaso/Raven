...
L["Spell ID (Tooltip)"] = true
L["If checked and control key is down, spell ID, when known, is added to tooltips."] = true
L["Caster (Tooltip)"] = true
L["If checked, caster for buffs and debuffs, when known, is added to tooltips."] = true
L["Spell ID (Label)"] = true
L["If checked, spell ID, when known, is added to labels."] = true
L["Caster (Label)"] = true
L["If checked, caster for buffs and debuffs, when known, is added to labels."] = true
