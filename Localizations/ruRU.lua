...
L['Include other debuffs not selected with filter types.'] = 'Включить другие дебаффы не выбранных типов.'
...
L['Include debuffs that the player can cast.'] = ''
L['Include debuffs that the player can cast.'] = ''
L["Include debuffs from effect timers triggered by a spell cast."] = ""
L["Include debuffs from spell alerts."] = ""
L['Exclude other debuffs not selected with filter types.'] = ''
L['Exclude debuffs that the player can dispel.'] = ''
L['Exclude debuffs cast by boss.'] = ''
L['Exclude poison debuffs.'] = ''
L['Exclude curse debuffs.'] = ''
L['Exclude magic debuffs.'] = ''
L['Exclude disease debuffs.'] = ''
L["Exclude enrage debuffs."] = ''
L['Exclude debuffs cast by an NPC (note: only valid while caster is selected, such as when checking target of target).'] = ''
L['Exclude debuffs cast by a vehicle (note: only valid while caster is selected, such as when checking target of target).'] = ''
L['Exclude debuffs that the player can cast.'] = ''
L["Exclude debuffs from effect timers triggered by a spell cast."] = ""
L["Exclude debuffs from spell alerts."] = ""
L['Exclude debuffs that the player can cast.'] = ''
L["If checked, the debuff filter list is shared with bar groups in other profiles with the same name."] = ""
L["Enter Debuff"] = ""
L["Enter a spell name (or numeric identifier, optionally preceded by # for a specific spell id) for a debuff to be added to the filter list."] = ""
L["Delete the selected debuff from the filter list."] = ""
L["Reset the debuff filter list."] = ""
