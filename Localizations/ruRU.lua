...
L["Spell Expire Time"] = "Время истечения заклинания"
...
L["Reset Expire Times"] = "Сброс времени истечения"
L["Reset expire times back to defaults."] = "Сброс времени истечения заклинания обратно к стандартному."
L["RESET EXPIRE TIMES\nAre you sure you want to reset all expire times back to defaults?"] = "СБРОС ВРЕМЕНИ ИСТЕЧЕНИЯ ЗАКЛИНАНИЯ\nВы уверены, что хотите сбросить время истечения заклинания обратно к стандартному?"
L["Reset Expire Colors"] = "Сброс цвета истечения"
L["Reset expire colors back to defaults."] = "Сброс цвета истечения заклинания обратно к стандартному."
L["RESET EXPIRE TIMES\nAre you sure you want to reset all expire colors back to defaults?"] = "СБРОС ЦВЕТА ИСТЕЧЕНИЯ ЗАКЛИНАНИЯ\nВы уверены, что хотите сбросить цвет истечения заклинания обратно к стандартному?"
