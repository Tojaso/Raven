						...
						TextSettings = {
							...
							args = {
								...
								TimeNormalGroup = {
									...
									desc = L["If checked, use normal alignment for time text, based on bar layout."],
								...
								TimeLeftGroup = {
									...
									desc = L["If checked, set \"Left\" alignment for time text."],
								...
								TimeCenterGroup = {
									...
									desc = L["If checked, set \"Center\" alignment for time text."],
								...
								TimeRightGroup = {
									...
									desc = L["If checked, set \"Right\" alignment for time text."],
